...
export const DashboardMenu = [
  ...
  //   icon: "user",
  //   children: [
  //     { id: uuid(), link: "/creator/booking", name: "Booking" },
  //     { id: uuid(), link: "/creator/communication", name: "Communication" },
  ...
  //     { id: uuid(), link: "/creator/crm-tools", name: "CRM tools" },
  //     { id: uuid(), link: "/creator/domain-management", name: "Domain management" },
  //     { id: uuid(), link: "/creator/certification", name: "Certification" },
  //     { id: uuid(), link: "/creator/mobile-app", name: "Mobile App" },
  //     { id: uuid(), link: "/creator/video-player", name: "Video player" },
  //     { id: uuid(), link: "/creator/storage-platform", name: "Storage platform" },
  //     { id: uuid(), link: "/creator/e-commerce", name: "E-commerce" },
  //     { id: uuid(), link: "/creator/social-media", name: "Social media" },
  //     { id: uuid(), link: "/creator/security", name: "Security" },
  //   ],
  // },
  {
    id: uuid(),
