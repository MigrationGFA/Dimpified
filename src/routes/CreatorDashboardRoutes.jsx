...
export const DashboardMenu = [
 ...
 
  {
    ...
    icon: "user",
    children: [
      { id: uuid(), link: "/creator/lms", name: "LMS" },
      ...
      { id: uuid(), link: "/creator/growth", name: "Growth" },
      { id: uuid(), link: "/creator/report", name: "Report" },
      { id: uuid(), link: "/creator/gamification", name: "Gamification" },
