...
// import media files
import FeaturedImg1 from "./images/customers.png";
  ...
  const featurescol1 = [
    {
      ...
      description:
        "List all your trade services clearly and attractively. Highlight your expertise in house cleaning, handyman services, electrical work, painting, auto repair, or carpentry to engage potential clients.",
    },
    {
      id: 2,
      icon: mdiLifebuoy,
