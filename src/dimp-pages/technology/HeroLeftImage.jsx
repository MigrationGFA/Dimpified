...
// import media files
import FeaturedImg1 from "./images/citizens.jpg";
  ...
  const featurescol1 = [
    {
      ...
      description:
        "Optimize your portfolio site for search engines. Increase your visibility and attract more potential clients and companies searching for tech and developer skills.",
    },
    {
      id: 2,
      icon: mdiLifebuoy,
      ...
      description:
        "Integrate your website with social media platforms. Share your projects and updates easily, reaching a broader audience and driving traffic to your site.",
    },
    {
      id: 3,
      ...
      description:
        "Gain insights into your website traffic and user behavior. Use our analytics tools to understand your audience and improve your online presence.",
    },
  ];
        ...
        <Col xl={{ offset: 2, span: 8 }} md={12} xs={12}>
          <div className="text-center mb-lg-10 mb-6">
            <h2 className="h1 fw-bold">
              Build your online presence effortlessly
            </h2>
          </div>
        </Col>
      </Row>
