  ...
  const featurescol1 = [
    {
      ...
      description:
        "Provide multiple payment options for clients, making it easy for them to pay for your services securely and conveniently.",
    },
    {
      id: 2,
      icon: mdiLifebuoy,
      ...
      description:
        "Monitor all transactions through a centralized dashboard, helping you keep track of your earnings and manage your finances efficiently.",
    },
    {
      id: 3,
      ...
      description:
        "Generate and send professional invoices automatically, ensuring timely payments and reducing manual work",
    },
  ];
