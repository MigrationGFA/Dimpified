  ...
  const featurescol1 = [
    {
      ...
      description:
        "Our e-commerce features enable you to list and sell products and services that support your mission. Offer religious books, merchandise, or event tickets, providing additional revenue streams for your organization.",
    },
    {
      id: 2,
      icon: mdiLifebuoy,
      ...
      description:
        "Handle sales and donations through our integrated payment management system. Ensure secure and transparent transactions, building trust with your community.",
    },
    {
      id: 3,
      ...
      description:
        "Track sales data with our interactive dashboard. Analyze revenue, identify popular products, and adjust your strategies to maximize your e-commerce efforts.",
    },
  ];
      ...
      <Row>
        <Col xl={{ offset: 2, span: 8 }} md={12} xs={12}>
          <div className="text-center mt-3 mt-lg-6 mb-6">
            <h2 className="h1 fw-bold">Support Your Mission with Online Sales</h2>
          </div>
        </Col>
      </Row>
