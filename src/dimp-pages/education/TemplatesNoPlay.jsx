              ...
              <Col lg={12} md={12} xs={12}>
                <div className="mb-5 mb-lg-0">
                  <h2 className="display-5 fw-bold mb-3 text-center">
                    Prioritise the well-being of your learners by offering a{" "}
                    <br />
                    fantastic branded learning experience.
                  </h2>
                  <p className="display-8 text-center">
                    Select from a variety of DIMP's website templates, customize
                    it with few clicks,
                    <br /> upload your course and you’re good to go. So simple,
                    so powerful.
                  </p>
                </div>
              </Col>
