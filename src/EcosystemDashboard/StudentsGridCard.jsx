...
const StudentsGridCard = ({ students }) => {
  ...
  const displayStudents = filteredStudents
    ...
    .map((student) => {
        ...
        const formattedDate = new Date(student.updatedAt).toLocaleDateString("en-GB", {
            day: "numeric",
            month: "long",
            year: "numeric",
        });
          ...
          <Card className="mb-4">
            <Card.Body>
              <div className="text-center">
                ...
                <p className="mb-1 fs-7">Username: {student.username}</p>
              ...
              <div className="d-flex justify-content-between border-bottom py-2 mt-4 fs-6">
                <span>Ecosystem </span>
                <span className="text-dark">{student.ecosystemDomain}</span>
              </div>
              <div className="d-flex justify-content-between pt-2 fs-6 align-items-center">
                <h5 className="">Contact Details</h5>
              </div>
              <hr />
              <div className="d-flex justify-content-between fs-6 align-items-center">
                <span>Email</span>
                <div className="text-end">{student.email}</div>
              </div>
              <hr />
              <div className="d-flex justify-content-between fs-6 align-items-center">
                <span>Phone Number</span>
                <div className="text-end">{student.phoneNumber}</div>
              </div>
              <hr />
              <div className="d-flex justify-content-between fs-6 align-items-center">
