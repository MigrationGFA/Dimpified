...
const Template4 = ({ details, subdomain, ecosystemDetails }) => {
  ...
  const handleShow = (service, serviceType, currency, domain) => {
    setServiceDetails({
      name: service.name,
      price: service.price,
        ...
        >
          <Container>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              ...
              <Button variant="light" href="#services" className="btn-lg">
                Book Appointment
                <ArrowRight />
              </Button>
            </Navbar.Collapse>
        ...
        <Fragment>
          <section
            ...
            style={{
              ...
              color: details.hero.styles.color || "black",
            }}
          >
            ...
            <Container
              className="h-100"
              style={{
                color: details.hero.styles.color,
              }}
            >
                ...
                >
                  <div className="feature-box feature-box-left-icon-middle last-paragraph-no-margin">
                    ...
                    <div className="feature-box-content ">
                      ...
                      <p>{sanitizeContent(details.Statistics.section1span)}</p>
                    </div>
                  </div>
                </Col>
                <Col
                  ...
                  <div className=" align-items-start process-step-item">
                    ...
                    <div className="ms-15px">
                      <p className="primary-font">
                        {" "}
                        {sanitizeContent(details.Statistics.section3icon)}
                      </p>
                    </div>
                  </div>
                </Col>
              ...
              <Row className="justify-content-center mb-4">
                ...
                >
                  ...
                  >
                    <span>
                      <span className="primary-font btn-text">
                        {sanitizeContent(details.Reviews.header2)}
                      </span>
                      <span className="primary-font btn-icon">
                        <ArrowRight />
                      </span>
                ...
                >
                  ...
                  <h6 className="alt-font fs-3 text-dark-gray">
                    {sanitizeContent(details.Reviews.header3)}
                  </h6>
              ...
              <Col key={index} className="mb-20px">
                ...
                {serviceItem.services &&
                  ...
                  serviceItem.services.map((service) => (
                    <Card
                      className="services-box-style-01 hover-box"
                      key={service._id}
                    >
