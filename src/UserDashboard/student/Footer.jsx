        ...
        <Container>
          <Row>
            <Col lg={4} md={6} sm={12}>
              {/* about company  */}
              <div className="mb-4">
                <Image src={FooterLogo} alt="" className="logo-inverse" style={{ height: '100px', width: '100px' }}/>
                <div className="mt-4">
                  <p>
                  Remsana is a comprehensive platform for learning and teaching, offering students the opportunity to learn and earn certifications, while providing instructors with the tools they need to teach effectively.
                  </p>
                  {/* social media */}
