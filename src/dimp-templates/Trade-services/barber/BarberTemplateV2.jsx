...
const BarberTemplateV2 = () => {
  ...
  const images = [
    ...
    "/images/Awesome 3.jpg",
    "/images/Awesome 3.jpg",
    "/images/Awesome 4.jpg",
    "/images/Awesome 5.jpg",
    "/images/Awesome 5.jpg",
  ];
  ...
  return (
    <div>
      ...
      <section
        style={{
          backgroundImage: `url('/images/Awesome 5.jpg')`,
            ...
            <Col xl={7} lg={7} md={12}>
              <div className="py-6 py-lg-0 text-center pt-lg-14">
                <h1 className="display-3 fw-bold mb-3 text-white">
                  <span className="text-white px-3  ">Awesome Barbers</span>
                </h1>
                <p className="mb-6 h2 text-dark">
                  #1 finest barbing services in Abeokuta
                </p>
              </div>
            </Col>
            ...
            <Col xxl={6} xl={6} lg={6} xs={12}>
              <div>
                ...
                <p className="text-dark fs-4 mb-4 pe-xl-12 ">
                  Welcome to Awesome Barbershop, your premier destination for
                  exceptional grooming services in the heart of Abeokuta. At
                  Awesome, we blend the finest traditions of barbering with
                  contemporary techniques to provide a grooming experience that
                  is both sophisticated and personalized.
                </p>
                <p className="text-dark fs-4 mb-4 pe-xl-12 ">
                  At Awesome, our mission is to deliver unparalleled barbering
                  services with a focus on quality, style, and customer
                  satisfaction. We believe that every client deserves to look
                  and feel their best, and our skilled barbers are dedicated to
                  making that happen.
                </p>
          ...
          <Row>
            ...
            <Col xl={3} lg={3} sm={12}>
              <Card style={{ margin: "10px", backgroundColor: "#f7f3e8" }}>
                ...
                />
                <Card.Body>
                  <Card.Title className="text-dark fs-3">Beard Trim</Card.Title>
                  <Card.Text>
          ...
          <Row>
            <Col md={6} className="mb-4 px-4 ps-lg-10">
              ...
              <div style={pricingStyle}>
                ...
                <p style={descriptionStyle}>
                  An extended haircut with additional styling, tailored to your
                  preferences.
                </p>
              </div>
            </Col>
          ...
          <Row className="g-4 justify-content-center mb-5">
            <Col xs={12} md={6} lg={3}>
              <Card className="border-0 rounded-3">
                ...
                <Card.ImgOverlay className="d-flex align-items-end p-3 bg-gradient-base-transparent rounded-3">
                  <div>
                    <Card.Title className="text-white fs-5">Ademola</Card.Title>
            ...
            <Col xs={12} md={6} lg={3}>
              <Card className="border-0 rounded-3">
                ...
                <Card.ImgOverlay className="d-flex align-items-end p-3 bg-gradient-base-transparent rounded-3">
                  <div>
                    <Card.Title className="text-white fs-5">Oludare</Card.Title>
                    <Card.Subtitle className="text-white fs-6">
                      Barber
                    </Card.Subtitle>
                  </div>
            ...
            <Col xs={12} md={6} lg={3}>
              <Card className="border-0 rounded-3">
                ...
                <Card.ImgOverlay className="d-flex align-items-end p-3 bg-gradient-base-transparent rounded-3">
                  <div>
                    <Card.Title className="text-white fs-5">Clement</Card.Title>
                    <Card.Subtitle className="text-white fs-6">
                      Hair Washer
                    </Card.Subtitle>
                  </div>
      ...
      >
        <Container className="py-lg-14 px-3 py-4">
          <h1 className="display-3 fw-bold mb-3 text-white">
            <span className=" px-3 px-md-0 ">Awesome Barbers</span>
          </h1>
          ...
          <Nav className="justify-content-center">
            <Nav.Link
              href="#facebook"
              style={{ ...iconStyle, fontSize: "20rem", ":hover": hoverStyle }}
            >
              <FaFacebookF />
            </Nav.Link>
            <Nav.Link
...
export default BarberTemplateV2;
