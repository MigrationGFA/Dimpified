...
// import media files
import FooterLogo from '../assets/images/brand/logo/gfa-blue.png';
				...
				<Container>
					<Row>
						<Col lg={4} md={6} sm={12}>
							{/* about company  */}
							<div className="mb-4">
								<Image src={FooterLogo} height={50} alt="" className="logo-inverse" />
								<div className="mt-4">
									<p>
									DIMP is an Ecosystem management platform that allows you to create, manage and monetize your ecosystem.
									</p>
									{/* social media */}
